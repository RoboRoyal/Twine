...
const symbol symbols[] = {
        ...
        {"__ANY__","Can take on any value and any type, is the default type"}
};
...
const functions builtInFunctions[] = {//TODO finish and organize
        {"abs","double","* value","Returns the absolute value of whatever is passed"},
        {"exit","void","int exitStatus=0","Exits the program. A return status of 0 means success, other numbers represent some failure"},
        {"fault", "void", "void", "Creates an unrecoverable error"},
        {"getenv", "string", "string varName", "Gets the value of the passed in environmental variable from the system"},
        ...
        {"insert", "void", "* list, int pos, * data", "Inserts data into list and give position"},
        ...
        {"pow", "double", "double base=2.71828182845904523536, double exponent=1","Raises base to the exponent(base^exponent) with base default as the value e"},//TODO in TwineLib
        ...
        {"randDouble","double","double min=0, double max=1.0","Returns a random number between he two values passed"},
        ...
        {"round","int","double target","Rounds the number passed to the nearest whole number. Rounds .5 up to 1"},//TODO add rounding types(to the even, up, down, towards 0, towards inf/-inf)
        {"root", "double", "double base, double N", "Takes the Nth root of the base"},
        {"sizeof", "int", "* data", "Returns the size, in bytes, of the object passed in"},
        {"sleep","void","double seconds=1.0","Pauses the current thread for the number of seconds given"},
        {"sort","__ANY__","* target","Sorts a list passed to it"},//TODO doesnt actually take *
        {"sqrt","double","double data","Returns the sqrt of whatever is passed"},
        ...
        {"toDouble","double","* data, int base=10","Converts what is passed to a double"},//TODO add support for base changes
...
const functions interpFunctions[] = {//functions only found while in interpreting mode
        ...
        {"setReport", "void", "int level=2", "Sets reporting level/debugging level"},
...
const nameSpace nameSpaces[] = {
        {"string", "Any combination of numbers, symbols, and letters of any length",
                {},//no static methods
                {
                        ...
                        {"find", "int", "string element", "Returns the position of the first matching occurrence of element"},
                        {"append", "string", "string data", "Appends current string with passed in string"},
                        {"compair", "int", "string data", "Compares two strings, 0=same string"},
        ...
        {"int", "A whole number(no decimal) between -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807 (64bit)",
                {},//no static methods
                {//list of dynamic methods
                },
        ...
        {"__ANY__", "Container for any other data type",
                {},//no static methods
                {
                        ...
                        {"dataSize", "int", "void", "Returns the size, in bytes, of the data stored"},
                        ...
                        {"sub", "__ANY__", "int startingPosition=0, int endingPosition=0", "Returns the elements from start to end, inclusive"},//TODO-implement
                ...
                {},//static vars
                {
                        {"type", "string", "The hidden type of the variable"},
                        {"ptr", "int", "The data held by the variable"},
        ...
        {"double", "Any number, including decimals",
                {},//no static methods
                {
                        //list of dynamic methods
                },
        ...
        {"Object", "All classes extend object(it is the base class of all user-made objects)",
                ...
                {
                        //list of dynamic methods
                        {"toString","string","void","Returns string representation of contained data: default is object location"},
                        {"toNum", "double", "int base=10","Returns number representation of object: default is object location"},
                },
        ...
        {"runnable", "Makes thing multithreaded",//also known as branch
                ...
                {},//static vars
                {
                        ...
                        {"__pause__", "bool", "If the thread/branch is currently set to pause at the beginning of the next cycle"},
                        {"__finish__", "bool", "If the thread has finished execution"},
                        {"__success__", "bool", "If the thread executed successfully"},
                },//dynamic vars
                {},//OPS
        },
